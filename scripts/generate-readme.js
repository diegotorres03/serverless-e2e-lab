...
5.  **Security:**
   ...
   3. **webapp authorization**
      1. [${enalbed(current, '5.3.1')}] ${branchData['5.3.1'].todo} ${branchData['5.3.1'].task}
      2. [${enalbed(current, '5.3.2')}] ${branchData['5.3.2'].todo} ${branchData['5.3.2'].task}
   4. **Permission Boundaries**
      1. [${enalbed(current, '5.4.1')}] ${branchData['5.4.1'].todo} ${branchData['5.4.1'].task}
      2. [${enalbed(current, '5.4.2')}] ${branchData['5.4.2'].todo} ${branchData['5.4.2'].task}
